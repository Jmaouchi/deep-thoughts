...
const Profile = (props) => {
  ...
  const { loading, data } = useQuery(userParam ? QUERY_USER : QUERY_ME, { // this will check if its me as a user, then it will serve only the data i need
    // if not it will serve all the data 
